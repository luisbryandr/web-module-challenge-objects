...
console.log('task 1', createMenuItem( 'cheesecake', 6, 'dinner'))
console.log('task 1a', createMenuItem( 'pudding', 3 , 'lunch'))
console.log( 'task 1b', createMenuItem( 'ice cream', 4, 'breakfast'))
...
*/
const person = reviews[5]
console.log('task 3',person.feedback)
...
reviews.push ({name: "Santiago", rating: 1, feedback: "this sucks"})
