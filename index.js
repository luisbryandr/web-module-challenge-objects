...
console.log('task1a',createMenuItem('tacos', 7, 'Breakfast'));
...
createMenuItem('pizza', 7, 'dinner');
console.log(createMenuItem('pizza', 7, 'dinner'));

createMenuItem('sandwich', 7, 'lunch');
console.log(createMenuItem('sandwich', 7, 'lunch'));

createMenuItem('salad', 9, 'lunch');
...
console.log('task 2', burger.discount('person'));
...
// reviews.push( {name: 'Rea', rating: 3, feedback:"it was good"});
